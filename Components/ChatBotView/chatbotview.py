...
class UcChatBotView(QWidget):
    ...
    def showRunErrorMessage(self):
        ...
        if self.trueData[0] == "#":
            message = '{0}. Hata <br /><br />{1}.<br/><p style="color:red"> Bu hataya çözüm bulamadım :( Dilerseniz bu satırın başına yorum işareti koyarak hata oluşmasını engelleyebilirim.:</p>&#9989;&nbsp; {2} <br/>'.format(
            ...
            message = '{0}. Hata <br /><br />{1}.<br/><p style="color:green">Girinti Hatası Tespit Edildi. Düzeltmek İçin Tıklayabilirsiniz...</p>  <br/>'.format(
